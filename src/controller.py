...
class Controller:
  def __init__(self, caption, icon, size):
    ...
    scenes = [
      [
        './assets/initialScreen1.png',
        './assets/initialScreen2.png'
      ],
      (0, 0, 0),
      [
        './assets/victoryScreen1.png',
        './assets/victoryScreen2.png'
      ], [
        './assets/endScreen1.png',
        './assets/endScreen2.png'
      ]
    ]
    self.scene_controller = SceneController(scenes, self.reset, self.screen)
